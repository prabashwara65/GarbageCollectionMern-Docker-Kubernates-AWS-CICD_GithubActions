...
function CreateVehicles() {
  ...
  const Submit = (e) => {
    ...
    axios.post("http://localhost:8000/vehicles/createVehicle", {
    ...
    <div className="flex h-100 bg-green-200 justify-center items-center">
      ...
      <div className="w-75 bg-white rounded-lg p-6 shadow-lg mt-5 mb-5 ">
        <form onSubmit={Submit}>
          <h1 className="text-2xl font-bold text-black mb-3">Add Vehicle Information</h1>
        
          <input type="hidden" name="systemDate" value={date} />
          <h3 className="text-l font-bold text-black mb-2">Identification</h3>
            ...
            <div>
              ...
              <input type="text" id="vehicleId" value={vehicleId} readOnly className="w-25 p-2 border-1 border-gray-400 rounded-lg text-sm text-gray-600" required
            ...
            <div>
              ...
              <input type="text" id="numberPlate" placeholder="Enter Vehicle Registration Number" className="w-25 p-2 border-1 border-gray-400 rounded-lg text-sm placeholder-gray-600 text-gray-600" required 
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              ...
              className="w-full p-2 border-1 border-gray-400 rounded-lg text-sm text-gray-500 placeholder-gray-600" required
            ...
            className="w-full p-2 border-1 border-gray-400 rounded-lg text-sm placeholder-gray-500 text-gray-600" required 
          ...
          <h3 className="text-l text-black font-bold mb-2 mt-4">Environmental Compliance</h3>
           ...
           <label htmlFor="fuelCapacity" className="block text-gray-900 font-medium mb-1 mt-2">Fuel Capacity</label>
              ...
              className="w-75 p-2 border-1 border-gray-400 rounded-lg text-sm text-gray-500 placeholder-gray-600" required
          ...
          <h3 className="text-l text-black font-bold mb-4 mt-4 ">Insurance Requirments</h3>
            ...
            className="w-full p-2 border-1 border-gray-500 rounded-lg text-sm text-gray-600 placeholder-gray-500" 
